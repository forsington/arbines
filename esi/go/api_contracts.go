 ...
 * @param optional nil or *ContractsApiGetCharactersCharacterIdContractsOpts - Optional Parameters:
...
func (a *ContractsApiService) GetCharactersCharacterIdContracts(ctx context.Context, characterId int32, localVarOptionals *ContractsApiGetCharactersCharacterIdContractsOpts) ([]GetCharactersCharacterIdContracts200Ok, *http.Response, error) {
	var (
		...
		localVarReturnValue []GetCharactersCharacterIdContracts200Ok
	)
 ...
 * @param optional nil or *ContractsApiGetCharactersCharacterIdContractsContractIdBidsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
func (a *ContractsApiService) GetCharactersCharacterIdContractsContractIdBids(ctx context.Context, characterId int32, contractId int32, localVarOptionals *ContractsApiGetCharactersCharacterIdContractsContractIdBidsOpts) ([]GetCharactersCharacterIdContractsContractIdBids200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCharactersCharacterIdContractsContractIdBids200Ok
	)
 ...
 * @param characterId An EVE character ID
 * @param contractId ID of a contract
 * @param optional nil or *ContractsApiGetCharactersCharacterIdContractsContractIdItemsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
func (a *ContractsApiService) GetCharactersCharacterIdContractsContractIdItems(ctx context.Context, characterId int32, contractId int32, localVarOptionals *ContractsApiGetCharactersCharacterIdContractsContractIdItemsOpts) ([]GetCharactersCharacterIdContractsContractIdItems200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCharactersCharacterIdContractsContractIdItems200Ok
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contractId ID of a contract
 * @param optional nil or *ContractsApiGetContractsPublicBidsContractIdOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Page" (optional.Int32) -  Which page of results to return
...
func (a *ContractsApiService) GetContractsPublicBidsContractId(ctx context.Context, contractId int32, localVarOptionals *ContractsApiGetContractsPublicBidsContractIdOpts) ([]GetContractsPublicBidsContractId200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetContractsPublicBidsContractId200Ok
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/contracts/public/bids/{contract_id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"contract_id"+"}", fmt.Sprintf("%v", contractId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []GetContractsPublicBidsContractId200Ok
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 403 {
			var v GetContractsPublicBidsContractIdForbidden
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 404 {
			var v GetContractsPublicBidsContractIdNotFound
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contractId ID of a contract
 * @param optional nil or *ContractsApiGetContractsPublicItemsContractIdOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Page" (optional.Int32) -  Which page of results to return
...
func (a *ContractsApiService) GetContractsPublicItemsContractId(ctx context.Context, contractId int32, localVarOptionals *ContractsApiGetContractsPublicItemsContractIdOpts) ([]GetContractsPublicItemsContractId200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetContractsPublicItemsContractId200Ok
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/contracts/public/items/{contract_id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"contract_id"+"}", fmt.Sprintf("%v", contractId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []GetContractsPublicItemsContractId200Ok
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 403 {
			var v GetContractsPublicItemsContractIdForbidden
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 404 {
			var v GetContractsPublicItemsContractIdNotFound
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param optional nil or *ContractsApiGetContractsPublicRegionIdOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Page" (optional.Int32) -  Which page of results to return
...
func (a *ContractsApiService) GetContractsPublicRegionId(ctx context.Context, regionId int32, localVarOptionals *ContractsApiGetContractsPublicRegionIdOpts) ([]GetContractsPublicRegionId200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetContractsPublicRegionId200Ok
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/contracts/public/{region_id}/"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []GetContractsPublicRegionId200Ok
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 404 {
			var v GetContractsPublicRegionIdNotFound
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param optional nil or *ContractsApiGetCorporationsCorporationIdContractsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Page" (optional.Int32) -  Which page of results to return
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
func (a *ContractsApiService) GetCorporationsCorporationIdContracts(ctx context.Context, corporationId int32, localVarOptionals *ContractsApiGetCorporationsCorporationIdContractsOpts) ([]GetCorporationsCorporationIdContracts200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCorporationsCorporationIdContracts200Ok
	)
 ...
 * @param contractId ID of a contract
 * @param corporationId An EVE corporation ID
 * @param optional nil or *ContractsApiGetCorporationsCorporationIdContractsContractIdBidsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Page" (optional.Int32) -  Which page of results to return
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
func (a *ContractsApiService) GetCorporationsCorporationIdContractsContractIdBids(ctx context.Context, contractId int32, corporationId int32, localVarOptionals *ContractsApiGetCorporationsCorporationIdContractsContractIdBidsOpts) ([]GetCorporationsCorporationIdContractsContractIdBids200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCorporationsCorporationIdContractsContractIdBids200Ok
	)
 ...
 * @param contractId ID of a contract
 * @param corporationId An EVE corporation ID
 * @param optional nil or *ContractsApiGetCorporationsCorporationIdContractsContractIdItemsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
func (a *ContractsApiService) GetCorporationsCorporationIdContractsContractIdItems(ctx context.Context, contractId int32, corporationId int32, localVarOptionals *ContractsApiGetCorporationsCorporationIdContractsContractIdItemsOpts) ([]GetCorporationsCorporationIdContractsContractIdItems200Ok, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCorporationsCorporationIdContractsContractIdItems200Ok
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 520 {
			var v GetCorporationsCorporationIdContractsContractIdItemsError520
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
